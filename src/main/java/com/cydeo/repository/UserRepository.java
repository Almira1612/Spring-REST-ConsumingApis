...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query(value = "SELECT * FROM account_account ua JOIN account_details ad " +
                   "ON ad.id = us.account_details_id WHERE ad.age BETWEEN ?1 AND ?2",nativeQuery = true)
